...
public class FornecedorBean {
		...
		if(this.fornecedor != null && this.contato != null){
			...
			if(this.fornecedor.getIdFornecedor() != null){
				...
				try {
					...
					Mensagens.adicionarMensagemErro("N�o foi possivel cadastrar  o fornecedor");		
				}
	...
	/**
	 * @author alkxly
	 * @return - página de listagem de fornecedor
	 *
	 * Redireciona o link de listagem de fornecedor.
	 * 
	 * Página Origem : cadastroFornecedor.xhtml
	 * Página Destino : listarFornecedor.xhtml
	 */
	...
	public void excluir(){
		...
		try {
			...
			Mensagens.adicionarMensagemErro("N�o foi possivel excluir o fornecedor");	
		}
	...
	/**
	 * @author alkxyly
	 * @return p�gina de cadastro de fornecedor
	 * 
	 * Redireciona para p�gina de cadastro com o objeto selecionado para altera��o.
	 */
